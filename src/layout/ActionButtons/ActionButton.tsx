...
export const SmallBuyButton: React.FC<DefaultButtonsProps> = ({ onClick, disable, result = 0 }) => {
	...
	const resultLabel = (
		<>
			<Talk color="rot">{-result}</Talk> {SYSTEM.Gold}
		</>
	);
	const originalLabel = (
		<>
	...
	return (
		<button className="btn-small-right" onClick={handleClick} disabled={disable}>
			{disable ? disableLabel : displayLabel}
		</button>
	);
};
//#endregion
...
export const SmallSwapButton: React.FC<DefaultButtonsProps> = ({
	onClick,
	disable,
	result = 0,
}) => {
	...
	const textColor =
		result > 0 ? <Talk color="rot">{-result}</Talk> : <Talk color="grün">+{-result}</Talk>;
	const resultLabel = (
		<>
			{textColor} {SYSTEM.Gold}
		</>
	);
	const originalLabel = (
		<>
...
export const SmallSellButton: React.FC<DefaultButtonsProps> = ({ onClick, result = 0 }) => {
	...
	const resultLabel = (
		<>
			<Talk color="grün">+{result}</Talk> {SYSTEM.Gold}
		</>
	);
	const originalLabel = (
		<>
			<MultiColoredLetters colors={blueColors}>Verkaufen</MultiColoredLetters>: {resultLabel}
		</>
	);
	const displayLabel = showSuccess ? <Talk color="grün">Erfolg</Talk> : originalLabel;
	...
	return (
		<button className="btn-small-right" onClick={handleClick}>
			{displayLabel}
		</button>
	);
};
...
export const SmallEquipButton: React.FC<DefaultButtonsProps> = ({ onClick, disable, active }) => {
	...
	return (
		<button className={`btn-small ${active ? "" : ""}`} onClick={handleClick} disabled={disable}>
...
export const SmallUseButton: React.FC<DefaultButtonsProps> = ({ onClick, disable, active }) => {
	...
	return (
		<button className="btn-small" onClick={handleClick} disabled={disable}>
			<MultiColoredLetters colors={displayColor}>{displayLabel}</MultiColoredLetters>
		</button>
	);
};
