...
const MobileFooter: React.FC = observer(() => {
  ...
  return (
    <Suspense fallback={<div>Lädt…</div>}>
      ...
      >
        <GameNavi mobilePop={handleGame} />
      </div>
      <div
        className={`handyPop custom-scrollbar ${showInfo ? "open" : "closed"}`}
      >
        <InfoNavi mobilePop={handleInfo} />
      </div>
      <div
        className={`handyPop custom-scrollbar ${showNavi ? "open" : "closed"}`}
      >
