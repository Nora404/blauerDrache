...
export const quest003FindStone: GameQuest = {
	...
	description:
		"Jemand benötigt für den Bau seines Kellers drei faustgroße Steine. Bringe sie zur {ColoredText|weiß|bold}Truhe{/ColoredText} am schwarzen Brett beim {PLACES.Brunnen}.",
	reward:
