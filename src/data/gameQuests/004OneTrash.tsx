...
export const quest004OneTrash: GameQuest = {
  ...
  description:
    "Jemand glaubt im Müll am {PLACES.Südmauer} lägen vergessene Schätze. Bringe etwas zur Truhe am schwarzen Brett beim {PLACES.Brunnen}.",
  reward:
  ...
  buttons: [
    {
      ...
      getAction: () => {
        return {
          message: "Du hast für den Plunder 15 {SYSTEM.Gold} {Talk|grün}bekommen{/Talk} aber dein {SYSTEM.Ruf} {Talk|rot}sinkt{/Talk} um 3.",
