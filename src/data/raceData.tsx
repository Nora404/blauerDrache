...
export const races: Race[] = [
	...
	},
	{
		...
		ascii: <LizardAscii />,
		description:
			"In der öden Landschaft hinter den Steppen, weit außerhalb jeder Siedlung, leben die Echsen in kleineren nomadischen Gruppen. Artverwandt mit den Drachen haben sie es nicht leicht in dieser Welt. Hinzu kommt das viele Wesen ihnen keine größere Intelligenz zutrauen. Da Echsen andere Wesen meiden, wird sich ihr Ruf nicht sonderlich bald verbessern.",
	...
	},
	{
		...
		ascii: <DryadAscii />,
		description:
			"Dryaden brauchen Licht, sauberes Wasser und gute Erde. Sie fanden dies in der nähe der Quelle. Als Pflanzenwesen werden sie oft nur als solches wahrgenommen, als einfache Pflanze. Einige Wesen glauben nicht einmal das sie ein Bewusstsein haben. Sie brauchen keine Häuser, Technik oder Gold.",
		bonus: <>Du erhältst einen Bonus auf {SYSTEM.Leben}</>,
		base: {
			level: 1,
			maxLife: 120,
