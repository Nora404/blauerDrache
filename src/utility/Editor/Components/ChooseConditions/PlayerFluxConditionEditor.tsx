	...
	return (
		<div className="nested-section flex-warp -m-1 gradient">
			...
			<div className="form-group m-15">
				...
				<select value={flux.feeling || ""} onChange={(e) => setFlux("feeling", e.target.value)}>
			...
			<div className="form-group m-15">
				<label>Waffe: </label>
				<select value={flux.weapon || ""} onChange={(e) => setFlux("weapon", e.target.value)}>
			...
			<div className="form-group m-15">
				...
				<select value={flux.armor || ""} onChange={(e) => setFlux("armor", e.target.value)}>
			...
			<div className="form-group m-15">
				...
				<select value={flux.item || ""} onChange={(e) => setFlux("item", e.target.value)}>
