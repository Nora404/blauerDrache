...
const Admincenter: React.FC<AdmincenterProps> = observer(() => {
	...
	return (
		<div className="form-container max-width text-left">
			...
			<p>
				Verändere alle Daten, Listen oder Zustände. Teste Events, Quests oder Items. ligula eget
			...
			<details>
				...
				<div className="flex-row">
					<div className="flex-row">
						<div>
							<button className="redBtn3" onClick={() => handlePlayerBase("level", -1)}>
								1
							</button>
							<button className="redBtn2" onClick={() => handlePlayerBase("level", -3)}>
								3
							</button>
							<button className="redBtn1" onClick={() => handlePlayerBase("level", -5)}>
								5
							</button>
						</div>
						<div className="w100c">{SYSTEM.Level}</div>
						<div>
							<button className="greenBtn1" onClick={() => handlePlayerBase("level", 5)}>
								5
							</button>
							<button className="greenBtn2" onClick={() => handlePlayerBase("level", 3)}>
								3
							</button>
							<button className="greenBtn3" onClick={() => handlePlayerBase("level", 1)}>
								1
							</button>
						</div>
					</div>
				...
				<div className="flex-row">
					<div className="flex-row">
						<div>
							<button className="redBtn3" onClick={() => handlePlayerBase("ruf", -5)}>
								5
							</button>
							<button className="redBtn2" onClick={() => handlePlayerBase("ruf", -3)}>
								3
							</button>
							<button className="redBtn1" onClick={() => handlePlayerBase("ruf", -1)}>
								1
							</button>
						</div>
						<div className="w100c">{SYSTEM.Ruf}</div>
						<div>
							<button className="greenBtn1" onClick={() => handlePlayerBase("ruf", 1)}>
								1
							</button>
							<button className="greenBtn2" onClick={() => handlePlayerBase("ruf", 3)}>
								3
							</button>
							<button className="greenBtn3" onClick={() => handlePlayerBase("ruf", 5)}>
								5
							</button>
						</div>
					</div>
			...
			<details>
				...
				<div className="flex-row">
					<div className="flex-row">
						<div className="flex-row">
							<button className="redBtn3" onClick={() => handlePlayerStats("life", -1)}>
								1
							</button>
							<button className="redBtn2" onClick={() => handlePlayerStats("life", -10)}>
								10
							</button>
							<button className="redBtn1" onClick={() => handlePlayerStats("life", -50)}>
								50
							</button>
						</div>
						<div className="w100c">{SYSTEM.Leben}</div>
						<div className="flex-row">
							<button className="greenBtn1" onClick={() => handlePlayerStats("life", 50)}>
								50
							</button>
							<button className="greenBtn2" onClick={() => handlePlayerStats("life", 10)}>
								10
							</button>
							<button className="greenBtn3" onClick={() => handlePlayerStats("life", 1)}>
								1
							</button>
						</div>
					</div>
					...
					<div className="flex-row">
						<div className="flex-row">
							<button className="redBtn3" onClick={() => handlePlayerStats("actionPoints", -1)}>
								1
							</button>
							<button className="redBtn2" onClick={() => handlePlayerStats("actionPoints", -3)}>
								3
							</button>
							<button className="redBtn1" onClick={() => handlePlayerStats("actionPoints", -5)}>
								5
							</button>
						</div>
						<div className="w100c">{SYSTEM.Aktionen}</div>
						<div className="flex-row">
							<button className="greenBtn1" onClick={() => handlePlayerStats("actionPoints", 5)}>
								5
							</button>
							<button className="greenBtn2" onClick={() => handlePlayerStats("actionPoints", 3)}>
								3
							</button>
							<button className="greenBtn3" onClick={() => handlePlayerStats("actionPoints", 1)}>
								1
							</button>
						</div>
					</div>
				...
				<div className="flex-row">
					<div className="flex-row">
						<div className="flex-row">
							<button className="redBtn3" onClick={() => handlePlayerStats("attack", -1)}>
								1
							</button>
							<button className="redBtn2" onClick={() => handlePlayerStats("attack", -5)}>
								5
							</button>
							<button className="redBtn1" onClick={() => handlePlayerStats("attack", -10)}>
								10
							</button>
						</div>
						<div className="w100c">{SYSTEM.Angriff}</div>
						<div className="flex-row">
							<button className="greenBtn1" onClick={() => handlePlayerStats("attack", 10)}>
								10
							</button>
							<button className="greenBtn2" onClick={() => handlePlayerStats("attack", 5)}>
								5
							</button>
							<button className="greenBtn3" onClick={() => handlePlayerStats("attack", 1)}>
								1
							</button>
						</div>
					</div>
					...
					<div className="flex-row">
						<div className="flex-row">
							<button className="redBtn3" onClick={() => handlePlayerStats("defense", -1)}>
								1
							</button>
							<button className="redBtn2" onClick={() => handlePlayerStats("defense", -5)}>
								5
							</button>
							<button className="redBtn1" onClick={() => handlePlayerStats("defense", -10)}>
								10
							</button>
						</div>
						<div className="w100c">{SYSTEM.Verteidigung}</div>
						<div className="flex-row">
							<button className="greenBtn1" onClick={() => handlePlayerStats("defense", 10)}>
								10
							</button>
							<button className="greenBtn2" onClick={() => handlePlayerStats("defense", 5)}>
								5
							</button>
							<button className="greenBtn3" onClick={() => handlePlayerStats("defense", 1)}>
								1
							</button>
						</div>
					</div>
				...
				<div className="flex-row">
					<div className="flex-row">
						<div className="flex-row">
							<button className="redBtn3" onClick={() => handlePlayerStats("luck", -1)}>
								1
							</button>
							<button className="redBtn2" onClick={() => handlePlayerStats("luck", -5)}>
								5
							</button>
							<button className="redBtn1" onClick={() => handlePlayerStats("luck", -10)}>
								10
							</button>
						</div>
						<div className="w100c">{SYSTEM.Glück}</div>
						<div className="flex-row">
							<button className="greenBtn1" onClick={() => handlePlayerStats("luck", 10)}>
								10
							</button>
							<button className="greenBtn2" onClick={() => handlePlayerStats("luck", 5)}>
								5
							</button>
							<button className="greenBtn3" onClick={() => handlePlayerStats("luck", 1)}>
								1
							</button>
						</div>
					</div>
			...
			<details>
				...
				<div className="flex-row">
					<div className="flex-row">
						<div>
							<button className="redBtn3" onClick={() => handlePlayerEconomy("gold", -500)}>
								500
							</button>
							<button className="redBtn2" onClick={() => handlePlayerEconomy("gold", -200)}>
								200
							</button>
							<button className="redBtn1" onClick={() => handlePlayerEconomy("gold", -50)}>
								50
							</button>
						</div>
						<div className="w100c">{SYSTEM.Gold}</div>
						<div>
							<button className="greenBtn1" onClick={() => handlePlayerEconomy("gold", 50)}>
								50
							</button>
							<button className="greenBtn2" onClick={() => handlePlayerEconomy("gold", 200)}>
								200
							</button>
							<button className="greenBtn3" onClick={() => handlePlayerEconomy("gold", 500)}>
								500
							</button>
						</div>
					</div>
