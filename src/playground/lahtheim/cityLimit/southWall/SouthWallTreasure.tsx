...
// #region [prepare]
type SouthWallTreasureProps = {
};

const SouthWallTreasure: React.FC<SouthWallTreasureProps> = () => {
    ...
    return (
        <div className='max-width'>
            <h2>Nach verlorenen Schätzen suchen</h2>
...
export default SouthWallTreasure;