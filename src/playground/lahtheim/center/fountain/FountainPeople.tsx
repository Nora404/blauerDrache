    ...
    const description =
        <>
            <p className='mb-1 text-left'>
                Endtäuschst stellst du fest, dass die <MultiColoredLetters colors={yellowColors}>Autorin</MultiColoredLetters> der Texte hier noch keinen Inhalt hinzugefügt hat. Außer diese paar Wörter, aber das hilft dir auch nicht weiter.
            </p>
        </>
    // #endregion
