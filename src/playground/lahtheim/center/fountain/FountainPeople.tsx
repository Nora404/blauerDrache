	...
	const description = (
		<>
			<p className="mb-1 text-left">
				...
				<MultiColoredLetters colors={yellowColors}>Autorin</MultiColoredLetters> der Texte hier noch
				keinen Inhalt hinzugefügt hat. Außer diese paar Wörter, aber das hilft dir auch nicht
				weiter.
			</p>
		</>
	);
