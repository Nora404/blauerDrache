...
import {
  ...
  ENEMIELIST,
  WEAPONSLIST,
} from "../../../data/helper/randomSentenceData";
import Header from "../../../layout/Header/Header";
import { GradientText } from "../../../utility/Formatted/GradientText";
import RandomSentence from "../../../utility/Random/RandomSentence";
...
const Start: React.FC<StartProps> = observer(() => {
  ...
  return (
    <div className="max-width">
      ...
      <p className="mb-1">
        Die aktuelle Uhrzeit in Lahtheim ist{" "}
        <b>{gameTime.data.gameTime} Uhr.</b> Es ist{" "}
        <b>{gameTime.data.gameDay}</b>. Das Wetter heute ist{" "}
        {gameState.data.weather} und {gameState.data.temperature}.
      </p>
      ...
      {!gameState.data.creating && (
        <ActionButton
          onClick={handleCreateCharakter}
          label="Charater erstellen"
        />
      )}
      <br />
      <br />
      ...
      <div>
        ...
        <RandomSentence
          partOne={NAMELIST}
          partTwo={BATTLELIST}
          partThree={ENEMIELIST}
          partFour={WEAPONSLIST}
        />
        <RandomSentence
          partOne={NAMELIST}
          partTwo={BATTLELIST}
