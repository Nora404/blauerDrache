...
export const ChooseRaceText: React.FC = () => {
	return (
		<div className="text-left">
			<p className="mb-1">
				Ein kleines {CREATURE.blauesWesen} fliegt direkt auf dich zu. Es hält nur wenige Zentimeter
				vor deinem Kopf an und betrachtet dich kritisch.
			</p>
			...
			<p className="mb-1">
				<Talk color="blauesWesen">
					"Also, wir sind hier, um dich mit diesem Reich vertraut zu machen, also tust du gut daran,
					uns ganz genau zuzuhören"
				</Talk>
			</p>
			...
			<p className="mb-1">
				...
				{CREATURE.blauesWesen} einen Notizblock und zaubert eine Füllfeder aus dem Nichts heraus. Es
				macht sich bereit zu schreiben ...
			</p>
		</div>
	);
};
...
export const ChooseCallingText: React.FC = () => {
	return (
		<div className="text-left">
			...
			<p className="mb-1">
				<Talk color="rotesWesen">
					"Das meinst du nicht ernst oder? Von denen hier laufen doch hunderte herum und tun so als
					wären sie einzigartig und die 'Auserwählten' um unser reich vor den Drachen zu retten!"
				</Talk>
			</p>
			<p className="mb-1">
				<Talk color="blauesWesen">
				...
				freundliche Worte aus. In der Zeit überlegst du warum es dich nach Lahtheim verschleppt hat.
...
export const ChooseNameText: React.FC = () => {
	return (
		<div className="text-left">
			<p className="mb-1">
				Nachdem du deine Berufung offenbart hast lassen die beiden streitenden Wesen von einander ab
				und wenden sich wieder dir zu. Das {CREATURE.blaueWesen} nickt zufrieden.
				<Talk color="blauesWesen">"Sehr gut, ich notiere das ..." </Talk> Nachdem es mit
				dramatischer Bewegung den letzten Strich gezogen hat, das {CREATURE.roteWesen} rollt mit den
				Augen, fragt es dich mit verheißungsvoller Stimme:
			</p>
			<p className="mb-1">
...
export const FinalText: React.FC = () => {
	return (
		<div className="text-left">
			...
			<p className="mb-1">
				<Talk color="rotesWesen">"Endlich vorbei und jetzt hau schon ab."</Talk> Beide Wesen wenden
				sich von dir ab und fliegen davon. Plötzlich dreht das {CREATURE.roteWesen} noch einmal um,
				schwebt zu dir und sagt mit einem führ ihn seltsam wirkenden Lächeln:
